...
def make_histogram(filename, log_plot, output_filename):
...
if __name__ == "__main__":
 ...
 #                    action='store_true', help='plot y axis as log plot')
	...
	make_histogram(args.filename, False, 'score_plot.png')
	make_histogram(args.filename, True, 'score_plot_log.png')
